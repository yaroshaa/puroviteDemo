<div class="p-2 xl:py-12 lg:py-12 md:py-6 sm:py-4 lt:py-4 lg:mt-20 xl:mt-20">
    <div class="max-w-7xl mx-auto lt:mb-3 sm:mb-3 md:mb-8 lg:mb-44 xl:mb-44">
        <div class="text-white">
            <h2 class="uppercase lt:text-2xl sm:text-2xl md:text-6xl lg:text-8xl 2xl:text-8xl">{{ __('Better Health') }}</h2>
            <div class="lg:my-16 sm:my-2 w-3/4 sm:text-xs md:text-2xl">We specialize in complex research, development,
                flavoring, and formulation requests. Plus, our customer service policies and support team are superior!
            </div>
            <div class="flex lg:flex-row lg:justify-start sm:flex-col lt:flex-col">
                <div class="xl:w-1/4 lg:w-1/4 md:w-full sm:w-full lt:w-full my-4">
                    <div class="flex flex-nowrap justify-start items-center">
                        <div class="icon inline-block ">
                            <svg viewBox="0 0 100 100" fill="none"
                                 class="sm:w-20 sm:h-20 lt:w-20 lt:h-20"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path d="M62.5 37.5L15.625 84.375"
                                      class="lt:stroke-gray-500 sm:stroke-gray-500 md:stroke-white lg:stroke-white xl:stroke-white"
                                      stroke-width="4"
                        ...
                        <div class="icon inline-block ">
                            <svg viewBox="0 0 100 100" fill="none"
                                ...
                                <path
                                    ...
                                    stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M37.5 50H62.5"
                                      class="lt:stroke-gray-500 sm:stroke-gray-500 md:stroke-white lg:stroke-white xl:stroke-white"
                                      stroke-width="4" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                                <path d="M90.625 50H96.875"
                                      class="lt:stroke-gray-500 sm:stroke-gray-500 md:stroke-white lg:stroke-white xl:stroke-white"
                                      stroke-width="4" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                                <path d="M3.125 50H9.375"
                                      class="lt:stroke-gray-500 sm:stroke-gray-500 md:stroke-white lg:stroke-white xl:stroke-white"
                                      stroke-width="4" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                            </svg>
