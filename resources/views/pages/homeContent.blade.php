<div class="py-12 mt-20">
    <div class="max-w-7xl mx-auto mb-44">
        <div class="w-4/5 text-white">
            <h2 class="uppercase text-8xl">{{ __('Better Health') }}</h2>
            <div class="my-16 pl-1 w-3/4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque
                blandit in purus sit amet fermentum. Aliquam facilisis suscipit commodo. In eu urna commodo,
                interdum ante id, semper purus. Praesent vulputate odio vitae quam dapibus volutpat. Fusce vel massa
                eu magna suscipit imperdiet id in enim. Etiam efficitur
            </div>
            <div class="flex justify-start">
                <div class="w-1/4 my-4">
                    <div class="flex flex-nowrap justify-start">
                        <div class="icon inline-block w-1/3">
                            <svg viewBox="0 0 100 100" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path d="M62.5 37.5L15.625 84.375" stroke="white" stroke-width="4"
                                      stroke-linecap="round" stroke-linejoin="round"/>
                                <path
                                    d="M25 75.0001C6.24997 43.7501 31.25 12.5001 84.375 15.6251C87.5 68.7501 56.25 93.7501 25 75.0001Z"
                                    stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </div>
                        <div class="text inline-block w-3/4 px-4">
                ...
                <div class="w-1/4 my-4">
                    <div class="flex flex-nowrap justify-start">
                        <div class="icon inline-block w-1/4">
                            <svg viewBox="0 0 100 100" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M34.375 21.875H25C23.2741 21.875 21.875 23.2741 21.875 25V75C21.875 76.7259 23.2741 78.125 25 78.125H34.375C36.1009 78.125 37.5 76.7259 37.5 75V25C37.5 23.2741 36.1009 21.875 34.375 21.875Z"
                                    stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                                <path
                                    d="M75 21.875H65.625C63.8991 21.875 62.5 23.2741 62.5 25V75C62.5 76.7259 63.8991 78.125 65.625 78.125H75C76.7259 78.125 78.125 76.7259 78.125 75V25C78.125 23.2741 76.7259 21.875 75 21.875Z"
                                    stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                                <path
                                    d="M78.125 31.25H87.5C88.3288 31.25 89.1237 31.5792 89.7097 32.1653C90.2958 32.7513 90.625 33.5462 90.625 34.375V65.625C90.625 66.4538 90.2958 67.2487 89.7097 67.8347C89.1237 68.4208 88.3288 68.75 87.5 68.75H78.125"
                                    stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                                <path
                                    d="M21.875 68.75H12.5C11.6712 68.75 10.8763 68.4208 10.2903 67.8347C9.70424 67.2487 9.375 66.4538 9.375 65.625V34.375C9.375 33.5462 9.70424 32.7513 10.2903 32.1653C10.8763 31.5792 11.6712 31.25 12.5 31.25H21.875"
                                    stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M37.5 50H62.5" stroke="white" stroke-width="4" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                                <path d="M90.625 50H96.875" stroke="white" stroke-width="4" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                                <path d="M3.125 50H9.375" stroke="white" stroke-width="4" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                            </svg>
                        </div>
                        <div class="text inline-block w-3/4 px-4">
                    ...
                    <div class="flex flex-nowrap justify-start">
                        <div class="icon inline-block w-1/4">
                            <svg viewBox="0 0 100 100" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M82.8125 50C87.1272 50 90.625 46.5022 90.625 42.1875C90.625 37.8728 87.1272 34.375 82.8125 34.375C78.4978 34.375 75 37.8728 75 42.1875C75 46.5022 78.4978 50 82.8125 50Z"
                                    stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                                <path
                                    d="M17.1875 50C21.5022 50 25 46.5022 25 42.1875C25 37.8728 21.5022 34.375 17.1875 34.375C12.8728 34.375 9.375 37.8728 9.375 42.1875C9.375 46.5022 12.8728 50 17.1875 50Z"
                                    stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                                <path
                                    d="M35.9375 31.25C40.2522 31.25 43.75 27.7522 43.75 23.4375C43.75 19.1228 40.2522 15.625 35.9375 15.625C31.6228 15.625 28.125 19.1228 28.125 23.4375C28.125 27.7522 31.6228 31.25 35.9375 31.25Z"
                                    stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                                <path
                                    d="M64.0625 31.25C68.3772 31.25 71.875 27.7522 71.875 23.4375C71.875 19.1228 68.3772 15.625 64.0625 15.625C59.7478 15.625 56.25 19.1228 56.25 23.4375C56.25 27.7522 59.7478 31.25 64.0625 31.25Z"
                                    stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                                <path
                                    d="M71.5764 60.8803C67.6569 58.7033 64.7555 55.0667 63.5034 50.7616L63.503 50.762C62.6532 47.8382 60.8773 45.2693 58.4423 43.4413C56.0073 41.6133 53.0448 40.625 50 40.625C46.9552 40.625 43.9927 41.6133 41.5577 43.4413C39.1227 45.2693 37.3468 47.8382 36.4969 50.762L36.4966 50.7616C35.2444 55.0667 32.3431 58.7033 28.4235 60.8803C25.6001 62.4107 23.4739 64.9689 22.4857 68.0246C21.4974 71.0803 21.7228 74.3991 23.1152 77.293C24.5077 80.187 26.9603 82.4342 29.9647 83.5688C32.9691 84.7033 36.2949 84.6383 39.2527 83.3872C46.1393 80.5634 53.8607 80.5634 60.7473 83.3872C63.7053 84.6397 67.0319 84.7057 70.0372 83.5714C73.0425 82.4371 75.496 80.1896 76.8887 77.2949C78.2815 74.4003 78.5067 71.0807 77.5176 68.0245C76.5285 64.9683 74.4011 62.41 71.5764 60.8803H71.5764Z"
                                    stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
...
PuroVite is a nutraceutical contract manufacturer that can help you develop, test and bring your products to domestic and international markets quickly and efficiently. We are NSF GMP and NSF for Sports registered and use only the highest quality ingredients in our products.
    ...
    <div class="w-full mx-auto mt-44 certificate-bg py-20">
        <div class="max-w-7xl mx-auto my-10 text-white pt-2">
            <h2 class="uppercase text-6xl text-center font-medium my-8 px-4">{{ __('Quality control & quality assurance') }}</h2>
            <div class="flex ">
                <div class="w-1/5 text-left ml-5">
                    <span class="inline-block">
                        <svg width="190" height="auto" viewBox="0 0 206 170" fill="none"
                             xmlns="http://www.w3.org/2000/svg">
                        <path
